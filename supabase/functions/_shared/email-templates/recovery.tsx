...
export const RecoveryEmail = ({ confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Setze dein Passwort für Frauenmoment zurück</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Heading style={h1}>
            Setz dein<br />
            <em style={emphasis}>Passwort neu.</em>
          </Heading>
          <Text style={text}>
            Wir haben deine Anfrage erhalten, dein Passwort bei Frauenmoment
            zurückzusetzen. Klicke unten, um ein neues zu wählen.
          </Text>
